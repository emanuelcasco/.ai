...
[[LLM: If available, review any provided relevant documents to gather all relevant context before beginning. If at a minimum you cannot local `README.md` ask the user what docs will provide the basis for the architecture.]]
...
3. If no starter template is mentioned but this is a blank project:
...
[[LLM: Create a list of Architecture Decision Records (ADRs) for the project. Each ADR should be a single file in the docs/ folder. The file name should be the ADR number and the title of the ADR]]
