...
- An existing story needs improvement or clarification
- Story requirements are vague or incomplete
- Integration approach is unclear
- Acceptance criteria need strengthening
- Story scope needs validation against iteration standards
- NEVER infer, ALWAYS asks. For example:
  - if the story only says: "Please update "leadership location" to high-risk locations", ask about where is it located, which components are using that translation is only frontnend or also backend, etc.
  - the story says there is a bug in target tracking, ask in which component, what was the actual result, and what was the user expecting to happen.

**Escalate to create-epic when refinement reveals:**

- The story requires 2-3 coordinated stories
- Some design work is needed
- Multiple integration points are involved

**Escalate to full iteration PRD/Architecture process when refinement reveals:**

- The story requires multiple coordinated stories
